...
// Styling for the status badges (Dark Mode friendly)
...
const RideDetails: React.FC<RideDetailsProps> = ({ ride }) => {
  ...
  return (
    <div className="bg-[#1A1640]/80 backdrop-blur-md border border-white/10 rounded-2xl h-full flex flex-col shadow-xl overflow-hidden">
      ...
      {/* Scrollable Content */}
      <div className="flex-1 overflow-y-auto p-5 space-y-6 custom-scrollbar [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
        ...
        {ride.currentLocation?.lat && (
           <div className="mt-4 pt-4 border-t border-white/10">
             ...
             {/* CASE 1: Ride is In Progress (Green, Animated) */}
             ...
             /* CASE 2: Ride is Completed/Cancelled (Gray, Static) */
